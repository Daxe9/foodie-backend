...
export class AppService implements OnApplicationBootstrap {
    constructor(
        ...
        private userRepository: Repository<User> // @InjectRepository(Restaurant) // private restaurantRepository: Repository<Restaurant>, // @InjectRepository(Item) // private itemRepository: Repository<Item>, // @InjectRepository(Rider) // private riderRepository: Repository<Rider>
    ) {}
    getHello(): string {
